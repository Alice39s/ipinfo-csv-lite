...
func TestMmdbSmoke(t *testing.T) {
	...
	const wantDescription = "IPinfo Lite country, continent, and ASN database. Data source: https://ipinfo.io/lite; generated by: https://github.com/Alice39s/ipinfo-csv-lite; data license: https://creativecommons.org/licenses/by-sa/4.0/"
	if got := db.Metadata.Description["en"]; got != wantDescription {
